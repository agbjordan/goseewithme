    ...
    const DialogDelete = (
      ...
      >
        ...
        <DialogActions>
          ...
          <Button
            onClick={() => this.handleDelete(this.state.adminDeleteId)}
            color="secondary"
            autoFocus
          >
            DELETE
        ...
        <Table className={classes.table}>
          ...
          <TableHead>
            <TableRow className={classes.tableHead}>
              ...
              <TableCell className={classes.cellRole}>Role</TableCell>
          ...
          <TableBody>
            {admins && Object.keys(admins).length > 0 ? (
              admins
                ...
                .map((row, i) => {
                  let name = row.firstname + " " + row.surname;
                  return (
                    <TableRow className={classes.rows} key={i}>
                      <TableCell className={classes.cellName} scope="row">
                        {name}
                      </TableCell>
                      ...
                      <TableCell className={classes.cellDate} numeric>
                        <Moment format="DD MMM YYYY">{row.lastLogin}</Moment>
                      </TableCell>
                      <TableCell className={classes.cellAction} numeric>
                        <IconButton aria-label="Edit">
                          <EditIcon
                            onClick={() => this.handleClickUpdate(row._id)}
                          />
                        </IconButton>
                      </TableCell>
                      <TableCell className={classes.cellAction} numeric>
                        <IconButton aria-label="Delete">
                          <DeleteForeverIcon
                            onClick={() => this.handleClickDelete(row._id)}
                          />
                        </IconButton>
                      </TableCell>
                    </TableRow>
